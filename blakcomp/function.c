...
{"GetDateAndTime",      GETDATEANDTIME,  STORE_OPTIONAL, AEXPRESSION, AEXPRESSION, AEXPRESSION,
...
{"SetRoomDepthOverrideBSP",  SETROOMDEPTHOVERRIDEBSP, STORE_OPTIONAL, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"CalcUserMovementBucket",   CALCUSERMOVEMENTBUCKET, STORE_REQUIRED, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, 
         AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
...
{"GetRandomPointBSP",   GETRANDOMPOINTBSP, STORE_OPTIONAL, AEXPRESSION, AEXPRESSION, AEXPRESSION,  AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"GetStepTowardsBSP",   GETSTEPTOWARDSBSP, STORE_OPTIONAL, AEXPRESSION, AEXPRESSION,  AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION,
                                           AEXPRESSION, AEXPRESSION,  AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"GetRandomMoveDestBSP",   GETRANDOMMOVEDESTBSP, STORE_OPTIONAL, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION,
                                                 AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
