...
{ 
   ...
   DEBUG_GROUP,
   DEBUG_HEAP, DEBUG_TRANSMITTED_BYTES, DEBUG_HASH, DEBUG_PORTAL, DEBUG_TIME_CALLS,
   DEBUG_UDP, DEBUG_DUMPSTACK,DEBUG_WARN_NTH_LESS_1,
   ...
   MYSQL_GROUP,
   MYSQL_ENABLED,MYSQL_USERNAME, MYSQL_PASSWORD, MYSQL_HOST, MYSQL_CPORT, MYSQL_DB,
