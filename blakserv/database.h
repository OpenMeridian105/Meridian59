...
enum sql_recordtype
{
   ...
   STAT_LOGPEN_ITEM = 43,
   STAT_QUESTGIVER = 44,
   STAT_MAXSTAT = 44 // Equal to highest defined stat.
};
...
static sql_statistic_type Statistics_Table[] = {
   ...
   {STAT_NPCS,           7, "WriteNpcs", "wiki_npcs"},
   {STAT_WEAPONS,       14, "WriteWeapons", "wiki_weapons"},
   ...
   {STAT_REAGENTS,      11, "WriteReagents", "wiki_reagents"},
   {STAT_FOOD,          11, "WriteFood", "wiki_food"},
   {STAT_AMMO,          11, "WriteAmmo", "wiki_ammo"},
   {STAT_ARMOR,         11, "WriteArmor", "wiki_armor"},
   {STAT_MISCITEMS,     11, "WriteMiscItems", "wiki_miscitems"},
   {STAT_RINGS,         11, "WriteRings", "wiki_rings"},
   {STAT_RODS,          11, "WriteRods", "wiki_rods"},
   {STAT_POTIONS,       11, "WritePotions", "wiki_potions"},
   {STAT_SCROLLS,       11, "WriteScrolls", "wiki_scrolls"},
   {STAT_WANDS,         11, "WriteWands", "wiki_wands"},
   {STAT_QUESTITEMS,    11, "WriteQuestItems", "wiki_questitems"},
   {STAT_SKILLS,        12, "WriteSkills", "wiki_skills"},
   {STAT_NECKLACE,      11, "WriteNecklace", "wiki_necklace"},
   {STAT_INSTRUMENTS,   11, "WriteInstruments", "wiki_instruments"},
   {STAT_GEMS,          11, "WriteGems", "wiki_gems"},
   {STAT_OFFERINGS,     11, "WriteOfferings", "wiki_offerings"},
   {STAT_QUESTS,        11, "WriteQuests", "wiki_quests"},
   ...
   {STAT_LOGPEN,         7, "WriteLogpen", "player_logpen"},
   {STAT_LOGPEN_ITEM,    3, "WriteLogpenItem", "player_logpen_items"},
   {STAT_QUESTGIVER,     2, "WriteQuestGiver", "wiki_quest_giver"}
};
