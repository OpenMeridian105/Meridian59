 ...
 *
 ...
 6) seconds logged in (used to be credits, but tracked by second)
...
Bool LoadLineAccount(char *account_str,char *name_str,char *password_str,
                     ...
                     char *suspend_str, char *seconds_str);
...
Bool LoadLineAccount(char *account_str, char *name_str, char *password_str,
                     ...
                     char *suspend_str, char *seconds_str)
{
   int account_id, type, last_login_time, suspend_time, sec_logged_in;
   int index;
   char decoded[100];
   ...
   LoadAccount(account_id, name_str, decoded, email_str, type, last_login_time,
      suspend_time, sec_logged_in);
