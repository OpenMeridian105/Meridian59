...
typedef struct {
   ...
   int  dodge;     // # of milliseconds remaining in dodge effect (0 if off)
   int  dodgedir;  // direction of the dodge from -1024 (left) over 0 (back) to 1024 (right)
   int  dodgedis;  // number of server fine units the dodge should displace us (up to 64)
